...
public class InteractiveObjectTest {
    ...
    public void test1_createInteractiveObject() {
        ...
        String hint="hint";
        ItemList reward = new ItemList();

        //when
        InteractiveObject io = new InteractiveObject(name,description,place,quest,requiredItem,removeRequiredItem,wayName,hint,reward);
        ...
        assertEquals(io.getReward(),reward);
    }
}